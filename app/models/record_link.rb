class HuginnRecordLinkAgent::RecordLink < ActiveRecord::Base
  ...
  belongs_to :source_record, class_name: 'HuginnRecordLinkAgent::Record', foreign_key: :source_record_id
  belongs_to :target_record, class_name: 'HuginnRecordLinkAgent::Record', foreign_key: :target_record_id
